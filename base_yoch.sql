...
--
-- Servidor: localhost
-- Tiempo de generación: 12-07-2013 a las 20:30:33
...
(18, 'Ola k ase', '41eb6-OLAKASEIlustrado.jpg', '<p>\n o</p>\n');
...
--
-- Volcar la base de datos para la tabla `artistasdestacados`
--
...
--
-- Volcar la base de datos para la tabla `colaboradoresdestacados`
--
...
CREATE TABLE IF NOT EXISTS `convocatoria` (
  ...
  `curso_opt` varchar(300) NOT NULL,
...
(3, 'Nuevo', 'Tijuana', 6, '<p>\n atwszxerctgvyibuhoni</p>\n', '2013-05-09', '740c2-fat-boy.gif'),
(4, 'Tal evento', 'Arte y galeria', 4, '<p>\r\n	Fue un peque&ntilde;o evento de tal tal tal tal</p>\r\n', '2013-04-17', ''),
(5, 'Evento', 'Lop', 2, '<p>\n a:D</p>\n', '2013-05-17', 'd686c-108d5268191cb179fa0c46a5aa623da0.jpg'),
(6, 'prueba', 'prueb', 6, '<p>\n <img alt="" class="miniatura" img="" src="http://lemonart-tj.com/images/c60cc23d2f8e151f5558fe46a0df0661.jpg" /></p>\n<p>\n &nbsp;</p>\n<p>\n <img alt="" class="miniatura" src="http://lemonart-tj.com/images/bc17a5dedbf49d1d14487ff67cf64076.jpg"  600px; height: 800px;" /></p>\n<p>\n &nbsp;</p>\n', '0000-00-00', '');
...
--
-- Volcar la base de datos para la tabla `eventosdestacados`
--
...
--
-- Volcar la base de datos para la tabla `evento_proximo`
--
...
--
-- Volcar la base de datos para la tabla `home`
--
...
(1, '7ef298fed457062d527c7325b1b93f75.JPG'),
(2, '447601d93230a60f84c17b120e935440.JPG'),
(3, '28c6dfa464e1a8fbb4a7a9a7a56ecf5a.png');
...
--
-- Volcar la base de datos para la tabla `nosotros`
--
...
INSERT INTO `obra` (`id_obra`, `titulo`, `descripcion`, `imagen`, `id_artista`) VALUES
(4, '', 'ksjahcnasjdhfvklsjdhfkl ksncnjslk klcasjhklfjashdcn alscnjfhklcfn', '', 3),
(10, '', 'lcnlskfnj lasdnclsdnaf', '', 2),
(11, '', 'lsackjlank lkasnclnkfv lkasndvlnk ', '', 3),
(12, 'Snake', '<p>\n <strong>una obrea muy lorem lorem lorem lorem lorem lkjlk&ntilde;jsdfjbsdkjf</strong></p>\n<h  >\n <span ><strong>Trololol</strong></span></h3>\n', '2e636-innerspeaker.jpeg', 1),
(13, '', 'ljcanjlkasnjlvln llkasdjnlksacnñkasdfoui ñlaksdjcfnlñskadnjf lñasdncklfncd ñklasdncñklsndfcvn ', '', 1),
(14, '', 'ksjahcnasjdhfvklsjdhfkl ksncnjslk klcasjhklfjashdcn alscnjfhklcfn', '', 1),
(15, '', 'kasdjhcfksljfn kasnjfhkljahk nasklcnjfklnj kasndcfnkjsajl klasnjclkasfnkl jnklascnjflksjnlk jnaslkcnj', '', 1),
(16, '', 'lsknflsdfnj lanjsclñdfnñ nacslñdfnñl lñnaskcnjñl nlñasnkcñlfnk lñasjcnlñn lñnasclñfnñ ', '', 1),
(17, '', 'lscnjsnfñl ñlaskjdcnñl ñlascknjfñl nlñakcfnlñ lnasdcfnñln ñlanscflñ ñlascnkjlñkn lñascnlñnk aslñdnv', '', 1),
(18, '', 'laskdncfjlsñ lñskadjfncñlk nñlasdcnjlñk lñaksfjcnlñ ', '', 1),
(19, '', 'lsacnkjlskñdvnj asldkfnjclsdfkj saldfcjlsdk nasln', '', 1),
(20, '', 'lcnlskfnj lasdnclsdnaf', '', 1),
(21, '', 'una obrea muy lorem lorem lorem lorem lorem lkjlkñjsdfjbsdkjf', '', 1),
(22, '', 'una obrea muy lorem lorem lorem lorem lorem lkjlkñjsdfjbsdkjf', '', 1),
(23, '', 'ljcanjlkasnjlvln llkasdjnlksacnñkasdfoui ñlaksdjcfnlñskadnjf lñasdncklfncd ñklasdncñklsndfcvn ', '', 1),
(24, '', 'ksjahcnasjdhfvklsjdhfkl ksncnjslk klcasjhklfjashdcn alscnjfhklcfn', '', 1),
(25, '', 'kasdjhcfksljfn kasnjfhkljahk nasklcnjfklnj kasndcfnkjsajl klasnjclkasfnkl jnklascnjflksjnlk jnaslkcnj', '', 1),
(26, '', 'lsknflsdfnj lanjsclñdfnñ nacslñdfnñl lñnaskcnjñl nlñasnkcñlfnk lñasjcnlñn lñnasclñfnñ ', '', 1),
(28, '', 'laskdncfjlsñ lñskadjfncñlk nñlasdcnjlñk lñaksfjcnlñ ', '', 1),
(30, '', 'lcnlskfnj lasdnclsdnaf', '', 2),
(31, '', 'una obrea muy lorem lorem lorem lorem lorem lkjlkñjsdfjbsdkjf', '', 1),
(32, '', 'una obrea muy lorem lorem lorem lorem lorem lkjlkñjsdfjbsdkjf', '', 1),
(34, '', 'ksjahcnasjdhfvklsjdhfkl ksncnjslk klcasjhklfjashdcn alscnjfhklcfn', 'artista.gif', 3);
...
(9, 'Titulo', '', 'e3ad6-ghosts05b.jpg'),
(10, 'Tame impala', '', '0156f-Tame-Impala-Elephant.jpg');
